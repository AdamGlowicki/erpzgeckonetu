...
<body class="bg-default">
          ...
          <div class="col-lg-5 col-md-7">
              ...
              <div class="card-body px-lg-4 py-lg-4">
                ...
                <form role="form" name="login">
                  ...
                  <div class="text-center">
                    <button type="button" name="submit" class="btn btn-primary my-4">Logowanie</button>
                  </div>
                </form>
              </div>
            </div>
            <div class="row mt-3">
              <div class="col-12 text-right">
                <a href="/lostpassword" class="text-light"><small>Przypomnienie hasła</small></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <script src="{{ mix('assets/js/auth/login.js') }}"></script>
</body>
</html>
