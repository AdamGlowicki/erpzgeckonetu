    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-xs-4">
                ...
                <p class="warehouse ml-1">{{ $data->warehouse->name }} ({{ $data->warehouse->id }})<br>{{ $data->warehouse->street }}<br>{{ $data->warehouse->postcode }} {{ $data->warehouse->city }}</p>
            </div>
        ...
        <div class="row mt-5">
            <div class="col-xs-12">
                <table class="table">
                    ...
                    <tbody>
                        @foreach($data->warehousesOutCarsItem as $row)
                            <tr>
                                <td>{{ $row->item->id }}</td>
        ...
        <div class="row mt-2">
            <div class="col-xs-8 ml-2">
                ...
                <p class="user ml-1">{{ $data->user_approved->name }}</p>
            </div>
            <div class="col-xs-4">
                <strong>Przyjął</strong>
                <p class="user ml-1">{{ $data->user_get->name }}</p>
            </div>
        </div>
    </div>
</body>
